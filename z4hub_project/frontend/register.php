                            ...
                            <div class="mb-md-5 mt-md-4 pb-5">
                                <form action="functions/user/createUser.php" method="post">
                                    ...
                                    <div data-mdb-input-init class="form-outline form-white mb-4">
                                        ...
                                        <label class="form-label" for="typeEmailX">Nome do Usuário</label>
                                    </div>

                                    <div data-mdb-input-init class="form-outline form-white mb-4">
                                        <input type="email" id="email" name="email" class="form-control form-control-lg" />
                                        <label class="form-label" for="typeEmailX">Email do Usuário</label>
                                    </div>
                                    ...
                                    <div data-mdb-input-init class="form-outline form-white mb-4">
                                        <select id="inputPlan" class="form-control form-control-lg" name="plans">
                                            <option selected value="basic">Plano Básico</option>
