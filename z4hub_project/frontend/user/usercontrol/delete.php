...
<body>
                    ...
                    <div class="card bg-dark text-white" style="border-radius: 1rem;">
                        <div class="card-body p-5 text-center">
                            <div class="mb-md-5 mt-md-4 pb-5">
                                ...
                                <p class="text-white-50 mb-5">Insira o ID do Usuário que você gostaria de excluir.</p>

                                <form role="search" onsubmit="deleteUser();return false;" id="form" method="post">
    ...
    <script type="text/javascript">
        function deleteUser() {
            $.ajax({
                method: "POST",
                url: "../../functions/user/deleteUser.php",
                data: $("#form").serialize(),
