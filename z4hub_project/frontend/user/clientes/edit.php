                    ...
                    <div class="card bg-dark text-white w-100" style="border-radius: 1rem;">
                        <div class="card-body p-4 d-flex flex-column">
                            <div class="mt-md-4 pb-5 flex-grow-1">
                                ...
                                <form action="../../functions/client/updateClient.php" method="post">
                                    <input type="hidden" id="inputId" name="id">
                                    <div class="form-outline form-white mb-4">
                                        <label class="form-label text-left" for="name_client">Nome do Cliente</label>
                                        <input type="name_client" id="inputNameClient" name="name_client" class="form-control form-control-lg disabled" />
                                    </div>
                                    <div class="form-outline form-white mb-4">
                                        <label class="form-label" for="inputDocument">Documento do Cliente</label>
                                        <input type="document" id="inputDocument" name="document" class="form-control form-control-lg disabled" />
                                    </div>
