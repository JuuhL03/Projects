            ...
            <div>
                ...
                <div class="col d-inline-block shadow-lg p-3 mb-5 bg-body-tertiary rounded-5">
                    <div class="bg-body-tertiary">
                        ...
                        <h1 class="fs-4 text-center">Editar Cliente Existente</h1>
                    </div>
                    <div class="bg-body-primary">
                        <div class="dashCard">
                ...
                <div class="col d-inline-block shadow-lg p-3 mb-5 bg-body-tertiary rounded-5">
                    <div class="bg-body-tertiary">
                        ...
                        <h1 class="fs-4 text-center">Buscar Cliente Existente</h1>
                    </div>
                    <div class="bg-body-primary">
                        <div class="dashCard">
                ...
                <div class="col d-inline-block shadow-lg p-3 mb-5 bg-body-tertiary rounded-5">
                    <div class="bg-body-tertiary">
                        ...
                        <h1 class="fs-4 text-center">Excluir Cliente Existente</h1>
                    </div>
                    <div class="bg-body-primary">
                        <div class="dashCard">
