                    ...
                    <div class="card bg-dark text-white w-100" style="border-radius: 1rem;">
                        <div class="card-body p-4 text-center d-flex flex-column">
                            <div class="mt-md-4 pb-5 flex-grow-1">
                                ...
                                <p class="text-white-50 mb-5">Para buscar o produto, informe o ID ou Nome</p>
                    ...
                    <div class="card bg-dark text-white w-100" style="border-radius: 1rem;">
                        <div class="card-body p-4 d-flex flex-column">
                            <div class="mt-md-4 pb-5 flex-grow-1">
                                ...
                                <form method="post">
                                    <div class="form-outline form-white mb-4">
                                        <label class="form-label text-left" for="name_object">Nome do Produto</label>
                                        <input disabled type="name_object" id="inputNameObject" name="name_object" class="form-control form-control-lg disabled" />
                                    </div>
                                    <input type="hidden" id="id" name="id">
                                    <div class="form-outline form-white mb-4">
                                        <label class="form-label" for="inputPreco">Valor do Produto</label>
                                        <input disabled type="preco" id="inputPreco" name="preco" class="form-control form-control-lg disabled" />
                                    </div>
                                </form>
                            </div>
                        </div>
