                    ...
                    <div class="card bg-dark text-white" style="border-radius: 1rem;">
                        <div class="card-body p-4 text-center">
                            ...
                            <div class="mb-md-5 mt-md-4 pb-5">
                                <form action="../../functions/object/createObject.php" method="post">
                                    <h2 class="fw-bold mb-2 text-uppercase">Painel de Gerenciamento</h2>
                                    <p class="text-white-50 mb-5">Para cadastrar novo produto, preencha os campos abaixo!</p>

                                    <div data-mdb-input-init class="form-outline form-white mb-4">
                                        <input type="username" id="name_object" name="name_object" class="form-control form-control-lg" />
                                        <label class="form-label" for="inputObject">Nome do Produto</label>
                                    </div>
