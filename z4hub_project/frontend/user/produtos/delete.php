...
<body>
                    ...
                    <div class="card bg-dark text-white" style="border-radius: 1rem;">
                        <div class="card-body p-5 text-center">
                            <div class="mb-md-5 mt-md-4 pb-5">
                                ...
                                <p class="text-white-50 mb-5">Insira o ID do Produto que você gostaria de excluir.</p>

                                <form role="search" onsubmit="deleteObject();return false;" id="form" method="post">
                                    <div data-mdb-input-init class="form-outline form-white mb-4">
                                        <input class="form-control form-control-lg" type="search" id="id" name="id" placeholder="Search" aria-label="Search">
                                        <label class="form-label" for="id">Id do Produto</label>
                                    </div>  
    ...
    <script type="text/javascript">
        function deleteObject() {
            $.ajax({
                method: "POST",
                url: "../../functions/object/deleteObject.php",
                data: $("#form").serialize(),
